...
<form action="{{ route('basket_store') }}" method="POST">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="{{ route('product_list_pups','sort=price')}}">prix</a>
            <a class="dropdown-item" href="{{ route('product_list_pups','sort=name')}}">nom</a>
        </div>
    </div>
